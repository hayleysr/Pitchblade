...
NoiseGatePanel::NoiseGatePanel(AudioPluginAudioProcessor& proc) : processor(proc)
{
    ...
    thresholdSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 80, 25);
    ...
    attackSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 80, 25);
    ...
    releaseSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, true, 80, 25);
...
void NoiseGatePanel::resized()
{
    ...
    thresholdSlider.setBounds(dials.removeFromLeft(dialWidth).reduced(5));
    attackSlider.setBounds(dials.removeFromLeft(dialWidth).reduced(5));
    releaseSlider.setBounds(dials.reduced(5));
}
